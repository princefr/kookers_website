...
function SellItem({course}){
    return (

        <div className="flex flex-row h-36  py-1 justify-between">
        <div className="flex flex-row space-x-4">
            <div className="w-56 bg-red-800">
                <img src={course.photoUrl} className="object-cover h-full w-full"></img>
            </div>
