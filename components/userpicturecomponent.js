 ...
 
            {
                showDropDown ?
                    <div className="origin-top-right absolute right-0 mt-2 w-96 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                        ...
                        <div className="py-1" role="none">
                            <button onClick={goToMySells} className="flex flex-row px-4 py-2 text-sm text-gray-700 justify-between hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                            ...
                            <button onClick={goToMyOrders} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                                <div className="flex flex-row items-center space-x-2 ml-0">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 14l9-5-9-5-9 5 9 5z"></path><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z"></path><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"></path></svg>
                                    <div>Mes achats</div>
                                </div>
                            </button>
                            <button onClick={goToMyChannel} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                                <div className="flex flex-row items-center space-x-2 ml-0">
                        ...
                        <div className="py-1" role="none">
                            <button onClick={goToPaymentMethod} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                                <div className="flex flex-row items-center space-x-2 ml-0">
                            ...
                            <button onClick={goToWallet} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                                <div className="flex flex-row items-center space-x-2 ml-0">
                        ...
                        <div className="py-1" role="none">
                            <button onClick={goToSettings} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                                <div className="flex flex-row items-center space-x-2 ml-0">
                        ...
                        <div className="py-1" role="none">
                            <button onClick={() => firebaseUser.signOut()} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                                <div className="flex flex-row items-center space-x-2 ml-0">
