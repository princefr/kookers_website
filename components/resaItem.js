...
function ResaItem({resa, toggleAskConfirmPanel}){
    return (
        <tr>
            <td className="px-4 py-4 whitespace-nowrap">
                                                            ...
                                                            <td className="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                                <button onClick={(() => toggleAskConfirmPanel(resa._id))} href="#" className="text-indigo-600 hover:text-indigo-900 font-medium">Commander</button>
                                                            </td>
                                                        </tr>
    )
}
