...
import Navbar from '../components/Navbar'
  ...
  function Terms() {
      return (
        ...
        <main>
          <Navbar></Navbar>
          <div class="lg:flex lg:items-center lg:justify-between md:mx-auto px-4 py-10 md:container">
              <div class="flex-1 min-w-0">
                ...
                <div class="py-5">
                <h2 class="text-lg font-bold py-10 text-gray-600">1. Présentation </h2>
                  <h2 class="text-base font-bold text-gray-500">En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé aux utilisateurs du site internet www.getkookers.com l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi: </h2>
                  <p class="py-3">Propriétaire : ONDONDA Prince – 303 quai aux fleurs 91000 Evry
                  ...
                  <p class="py-3">Kookers met en relation des amateurs culinaires avec des utilisateurs souhaitant acquerir des plats cuisinés par ces derniers. </p>
              </div>
              </div>
          </div>
          <Footer></Footer>
